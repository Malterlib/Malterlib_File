	...
	namespace NFile
	{
		...
		private:
			...
			public:
				...
				NDataProcessing::CHashDigest_MD5 m_MD5Checksum;		// Validate the data
				...
				void f_Read(NStream::CBinaryStream &_Stream)
				{
					...
					{
						m_MD5Checksum = NDataProcessing::CHashDigest_MD5();
					}
				}
			...
			public:
				...
				NContainer::TCVector<uint8> m_ClusterMemory;
				...
				DMibIntrusiveLink(CClusterCacheEntry, NIntrusive::TCAVLLink<>, m_CacheLink);
			...
			public:
				...
				NIntrusive::TCAVLTree<CClusterCacheEntry::CLinkTraits_m_CacheLink, CClusterCacheEntry::CCompare> m_Tree;
				...
				CClusterCacheEntry *f_GetCluster(CClusterID _Cluster)
				{
					...
					{
						f_MakeSpace(1);
						NPtr::TCUniquePointer<CClusterCacheEntry> pCacheNew(fg_Construct());
			...
			public:
				...
				DMibIntrusiveLink(CDirectoryCacheEntry, NIntrusive::TCAVLLink<>, m_CacheLink);
			};
			...
			public:
				...
				NIntrusive::TCAVLTree<CDirectoryCacheEntry::CLinkTraits_m_CacheLink, CDirectoryCacheEntry::CCompare> m_Tree;
			...
			public:
				...
				DMibIntrusiveLink(CFileInternal, NIntrusive::TCAVLLink<>, m_CacheLink);
				...
				void f_Read(void *_pDest, CFilePos _Position, mint _nBytes)
				{
					...
					while (_nBytes)
					{
						...
						NMem::fg_MemCopy(pDest, pEntry->m_ClusterMemory.f_GetArray() + Pos, MaxBytes);
						pDest += MaxBytes;
						_nBytes -= MaxBytes;
				...
				void f_Write(const void *_pSource, CFilePos _Position, mint _nBytes)
				{
					...
					while (_nBytes)
					{
						...
						CClusterCacheEntry *pEntry = f_GetCluster(Pos);
						mint MaxBytes = fg_Min(ClusterSize - Pos, _nBytes);
						NMem::fg_MemCopy(pEntry->m_ClusterMemory.f_GetArray() + Pos, pSrc, MaxBytes);
...
//					CClusterID ClusterDataLocation = ClusterIndex / ClusterIDsPerCluster;
			...
			NIntrusive::TCAVLTree<CFileInternal::CLinkTraits_m_CacheLink, CFileInternal::CCompare> mp_InternalFiles;
		...
		public:
			...
			bint f_ReadFileToMemory(NStr::CStr const &_File, NContainer::TCVector<uint8> &_Data);
			...
			public:
				...
				bint f_WriteFileData(CVirtualFS::CFileRecord &_FileRecord, NContainer::TCVector<uint8> &_Data, mint _Length);
				bint f_ReadFileData(CVirtualFS::CFileRecord &_FileRecord, NContainer::TCVector<uint8> &_Data);
				static bint fs_ReadFileData(uint32 _Version, uint64 _ClusterSize, uint64 _ClusterIDsPerCluster, NStream::CBinaryStream *_pStorageStream, CVirtualFS::CFileRecord &_FileRecord, NContainer::TCVector<uint8> &_Data);
			...
			NDataProcessing::CHashDigest_MD5 f_GetFileChecksum(NStr::CStr const &_Path);
